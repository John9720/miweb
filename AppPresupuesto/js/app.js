...
const eliminarIngreso = (id)=>{
    let indiceEliminmar = ingresos.findIndex(ingreso => ingreso.id === id);
    ingresos.splice(indiceEliminmar, 1);
    cargarCabecero();
    cargarIngresos();
}
...
const agregarDato = ()=>{
    ...
    if(descripcion.value !== "" && valor.valu !== ""){
